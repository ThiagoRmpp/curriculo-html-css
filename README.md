# Meu Currículo Online (HTML e CSS)
...
1.  Clone este repositório para o seu computador: `git clone https://github.com/ThiagoRmpp/curriculo-html-css.git`
2.  Navegue até a pasta do projeto: `cd curriculo-html-css`
3.  Abra o arquivo `cv_thiagormpp.html` (ou o nome que você deu) em seu navegador preferido.

## O que Aprendi:

Ao desenvolver este currículo, consolidei meus conhecimentos em HTML e CSS, aprendendo a criar layouts claros, aplicar estilos de forma consistente e garantir a legibilidade das informações, que é crucial para qualquer documento profissional.
